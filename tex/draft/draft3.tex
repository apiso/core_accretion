...
\item Because subsequent growth accelerates, the time to reach the crossover mass is a good approximation of the total time to form a gas giant.
\end{enumerate}
...
\begin{subeqnarray}
\rho &\simeq& \rho\cb \left[ {\RB' \over r}\right]^{1/(\gamma -1)} \propto r^{-5/2} \slabel{eq:rhoconv}  \\
