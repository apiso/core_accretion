...
We see in Figure \ref{fig:deladmap} that the adiabatic gradient decreases significantly in regions of partial dissociation and partial ionization. This behavior is different than that of a mixture of molecular and atomic hydrogen (a mixture of protons and electrons), where $2/7<\delad<2/5$ ($\delad=2/5$). We  explain this in what follows. % where hydrogen is either partially dissociated or partially ionized. 
