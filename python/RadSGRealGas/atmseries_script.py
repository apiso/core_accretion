...
a = [30.0] # numpy.append([5.0], numpy.linspace(10, 100, 10))
...
for i in range(len(a)):
    atmseries(a[i], 3.2, 0.3, 6.0*Me, 6.0*Me, 1, nMpoints = 200, L1=10**17, L2=10**30, minMfrac = 1.05, \
              maxMfrac = 2.5, opacity = interp_opacity)
####
#for i in range(len(a)):
